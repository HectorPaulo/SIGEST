...
import ItemForm, {FormFieldValue, ItemFormState} from "@/components/private/ItemForm/ItemForm";

function EmployeeEditForm({
                              initialValues,
                              onSubmit,
                          }: {
    initialValues: Partial<ItemFormState['values']>;
    onSubmit: (formValues: Partial<ItemFormState['values']>) => Promise<void>;
}) {
    ...
    const setFormValues = React.useCallback(
        (newFormValues: Partial<ItemFormState['values']>) => {
    ...
    const setFormErrors = React.useCallback(
        (newFormErrors: Partial<ItemFormState['errors']>) => {
            setFormState((previousState) => ({
                ...previousState,
    ...
    const handleFormFieldChange = React.useCallback(
        (name: keyof ItemFormState['values'], value: FormFieldValue) => {
            const validateField = async (values: Partial<ItemFormState['values']>) => {
...
export default function EmployeeEdit() {
    ...
    const handleSubmit = React.useCallback(
        async (formValues: Partial<ItemFormState['values']>) => {
